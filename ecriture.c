    ...
    switch(t){
      case 1 :
        for(int j=0; j<n1*(n2-1); j+=n1){
          for(int i=1; i<n1; i++){
	    fprintf(maillage, "%d %d %d %d ", (i+j), (i+j+1), (i+j+n1), (i+j+n1+1));
      ...
      case 2 :
        for(int j=0; j<n1*(n2-1); j+=n1){
	  for(int i=1; i<n1; i++){
	    fprintf(maillage, "%d %d %d ", (i+j), (i+j+1), (i+j+n1));
	    fprintf(maillage, "%d %d %d \n", nRefAr[k][0], nRefAr[k][1], nRefAr[k][2]);
            fprintf(maillage, "\n");
	    k++;
	    fprintf(maillage, "%d %d %d ", (i+j+1), (i+j+n1), (i+j+n1+1));
	    fprintf(maillage, "%d %d %d \n", nRefAr[k][0], nRefAr[k][1], nRefAr[k][2]);
	    fprintf(maillage, "\n");
	    k++;	    
          }
